...
// when using modules, some handlers must be reachable globally via onclick attributes
// we will expose them once they are defined at the end of this file
...
Object.assign(window, {
  showPage, logout, login, register,
  openReserveModal, closeModal, submitReservation,
  openEditModal, closeEditModal, submitEdit, deleteReservation,
  applyFilters, applyAdminFilter,
  openAdminEditModal, closeAdminEditModal, submitAdminEdit, adminDeleteReservation,
  setTodayDefault,
});
